...
UTIL_FILES=lib/util/log.c lib/util/node_link.c lib/util/stack.c lib/util/string_builder.c
LIB=${TEMPLATE_FILES} ${SIMBLE_TABLE_FILES} ${UTIL_FILES}
...
hue:
	${CC} ${SIMBLE_TABLE_FILES} ${UTIL_FILES} hue.c -ggdb -o exe
